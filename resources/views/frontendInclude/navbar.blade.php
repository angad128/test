        ...
        <nav class="navbar container" data-spy="affix" data-offset-top="47">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="nav-item dropdown no-arrow">
                      <a class="nav-link dropdown-toggle" href="#" id="yearly_session" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span>{{ __('key.yearly_session') }}</span><span class="caret"></span>
                      </a>
                      <!-- Dropdown - User Information -->
                      <ul class="dropdown-menu dropdown-menu-right shadow animated-grow-in" aria-labelledby="yearly_session">
                        <center><li><a href="{!! url('/first/yearly_session'); !!}"><span>{{ __('key.first') }}</span></a></li></center>
                        <center><li><a href="{!! url('/second/yearly_session'); !!}"><span>{{ __('key.second') }}</span></a></li></center>
                        <center><li><a href="{!! url('/third/yearly_session'); !!}"><span>{{ __('key.third') }}</span></a></li></center>
                        <center><li><a href="{!! url('/fourth/yearly_session'); !!}"><span>{{ __('key.fourth') }}</span></a></li></center>
                        <center><li><a href="{!! url('/fifth/yearly_session'); !!}"><span>{{ __('key.fifth') }}</span></a></li></center>
                      </ul>
                    </li>
                </ul>
